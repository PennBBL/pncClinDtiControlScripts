...
Overall_Psycho = tmp$overall_psychopathology_4factorv2[Indice];
...
Motion_MeanRelRMS = tmp$dti64MeanRelRMS[Indice];

Resultant_Mat = "/data/joy/BBL/projects/pncClinDtiControl/data/subjectData/n1089_Bifactor_DtiMotion_Demogra.mat";
writeMat(Resultant_Mat, Scan_ID_SC = Scan_ID_SC, Sex = Sex, Age = Age, Mood = Mood, Psychosis = Psychosis, Externalizing = Externalizing, Phobias = Phobias, Overall_Psycho = Overall_Psycho, Motion_MeanRelRMS = Motion_MeanRelRMS);
Resultant_CSV = "/data/joy/BBL/projects/pncClinDtiControl/data/subjectData/n1089_Bifactor_DtiMotion_Demogra.csv";
All_Info_CSV = data.frame(Scan_ID_SC = Scan_ID_SC, Sex = Sex, Age = Age, Mood = Mood, Psychosis = Psychosis, Externalizing = Externalizing, Phobias = Phobias, Overall_Psycho = Overall_Psycho, Motion_MeanRelRMS = Motion_MeanRelRMS);
