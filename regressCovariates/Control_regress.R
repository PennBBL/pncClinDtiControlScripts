...
Con_FA_Path <- file.path(Control_Folder, 'Lausanne125_FA_control.mat');
Con_SC_Path <- file.path(Control_Folder, 'Lausanne125_SC_control.mat');
Con_volNormSC_Path <- file.path(Control_Folder, 'Lausanne125_volNormSC_control.mat');
...
writeMat(file.path(Control_Folder, 'Lausanne125_FA_Control_regRace.mat'), avg_cont_reg_Race = avg_cont_reg_Race, mod_cont_reg_Race = mod_cont_reg_Race, bnd_cont_reg_Race = bnd_cont_reg_Race, scan_ID = scan_ID);
writeMat(file.path(Control_Folder, 'Lausanne125_FA_Control_reg.mat'), avg_cont_reg = avg_cont_reg, mod_cont_reg = mod_cont_reg, bnd_cont_reg = bnd_cont_reg, scan_ID = scan_ID);
...
writeMat(file.path(Control_Folder, 'Lausanne125_SC_Control_regRace.mat'), avg_cont_reg_Race = avg_cont_reg_Race, mod_cont_reg_Race = mod_cont_reg_Race, bnd_cont_reg_Race = bnd_cont_reg_Race, scan_ID = scan_ID);
writeMat(file.path(Control_Folder, 'Lausanne125_SC_Control_reg.mat'), avg_cont_reg = avg_cont_reg, mod_cont_reg = mod_cont_reg, bnd_cont_reg = bnd_cont_reg, scan_ID = scan_ID);
...
writeMat(file.path(Control_Folder, 'Lausanne125_volNormSC_Control_regRace.mat'), avg_cont_reg_Race = avg_cont_reg_Race, mod_cont_reg_Race = mod_cont_reg_Race, bnd_cont_reg_Race = bnd_cont_reg_Race, scan_ID = scan_ID);
writeMat(file.path(Control_Folder, 'Lausanne125_volNormSC_Control_reg.mat'), avg_cont_reg = avg_cont_reg, mod_cont_reg = mod_cont_reg, bnd_cont_reg = bnd_cont_reg, scan_ID = scan_ID);
